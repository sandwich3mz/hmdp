...
// The SeckillVoucherFunc type is an adapter to allow the use of ordinary
// function as SeckillVoucher mutator.
type SeckillVoucherFunc func(context.Context, *ent.SeckillVoucherMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SeckillVoucherFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SeckillVoucherMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SeckillVoucherMutation", m)
}
...
// The ShopTypeFunc type is an adapter to allow the use of ordinary
// function as ShopType mutator.
type ShopTypeFunc func(context.Context, *ent.ShopTypeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ShopTypeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ShopTypeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ShopTypeMutation", m)
}
