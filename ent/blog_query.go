...
func (bq *BlogQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (bq *BlogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(blog.Table, blog.Columns, sqlgraph.NewFieldSpec(blog.FieldID, field.TypeInt64))
	_spec.From = bq.sql
